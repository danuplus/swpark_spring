...
<div id="content">
	<h3>글 편집</h3>
	<form action="edit" method="post" onsubmit="return checkForm(this)" >
	<input type="hidden" name="page" value="${page }" />
	<input type="hidden" name="no" value="${no }" />
	<table>
		<tr>
			<th width="60" align="center">작성자</th>
			<td><input type="text" size="15" name="writer" value="${board.writer }" />
		...
		<tr>
			...
			<td><input type="text" size="80" name="title" value="${board.title }" />
		...
		<tr>
			...
			<td>
				<textarea rows="20" cols="80" name="content">${board.content }</textarea><br />
	...
	<div align="center">
		...
		<input type="button" value="취 소" onclick="location.href='view?no=${no}&page=${page }&b=y'" />&nbsp;
