...
<div id="content">
	...
	<table>
		<tr>
			<th width="60">작성자</th>
			<td><input type="text" name="writer" size="15" value="${board.writer }" />
		...
		<tr>
			<th>제목</th>
			<td><input type="text" name="title" size="80" value="${board.title }"/>
				<span class="error-text" id="error_title"></span>
			</td>
		</tr>
		<tr>
			<th height="300">내용</th>
			<td><textarea rows="20" cols="80" name="content">${board.content }</textarea><br /><br />
