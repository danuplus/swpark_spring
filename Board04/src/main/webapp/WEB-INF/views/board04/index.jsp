...
<div id="content">
	...
	<table>
		...
		<tr>
			...
			<td><a href="view?no=${board.no }&page=${page }">${board.title }</a>
				<span class="small">(${board.reply_cnt })</span></td>
			<td align="center">${board.read_cnt }</td>
		...
		<tr>
			<td colspan="5" align="center">
				...
				<c:if test="${page < maxPage-1 }">
					<a href="index?page=${maxPage-1 }">다음 페이지&gt;</a>&nbsp;&nbsp;
				</c:if>
	...
	<div align="center">
		<input type="button" value="새 글 쓰기" onclick="location.href='new?page=${page}'" />
	</div>
</div>
</body>
</html>